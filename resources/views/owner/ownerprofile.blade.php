...
<main class="account-container">
    ...
    <section class="form-section">
      ...
      <div class="card">
        <h4>• My Halls List</h4>
        <p>
          Browse the list of your halls and check their information... you can edit or delete them...
          <a href="myHallListing.html"><i class="fa-solid fa-chevron-right"></i></a>
        </p>
      </div>
      ...
      <div class="card">
        <h4>• Calendar</h4>
        <p>
          Increase bookings by keeping your calendar updated. Import your events into EventHalls
          <a href="calendar.html"><i class="fa-solid fa-chevron-right"></i></a>
        </p>
      </div>
      <div class="card">
        <h4>• Notifications</h4>
