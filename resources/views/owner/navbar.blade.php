    ...
    <ul class="nav-links">
      ...
      <div class="user-menu-container">
        ...
        <div class="profile-dropdown" id="userMenu" role="menu" >
          <ul role="none">
            <li role="menuitem"><a href="#">Bookings</a></li>
                        <li role="menuitem"><a href="{{ route('owner.calendar') }}">Calendar</a></li>
                        <li role="menuitem"><a href="{{ route('owner.reviews') }}">Reviews</a></li>
                        <li role="menuitem"><a href="{{ route('profile.show') }}">Profil</a></li>
                        <li role="menuitem"><a href="{{ route('owner.addHall') }}">Add a Hall</a></li>
